...
var Builder = /** @class */ (function () {
    ...
    Builder.createModules = function (tree, namespace, models, modules) {
        ...
        Object.keys(modules).forEach(function (name) {
            ...
            tree.modules[name].getters = tslib_1.__assign({}, Getters, module.getters);
            tree.modules[name].actions = tslib_1.__assign({}, Actions, module.actions);
    ...
    Builder.createState = function (namespace, name, model, module) {
        ...
        return tslib_1.__assign({}, modelState, moduleState, { $connection: namespace, $name: name, data: {} });
    };
    return Builder;
}());
