...
export { install, use, Database, Model, Query, Attribute, Type, Attr, String, Number, Boolean, Increment, Relation, HasOne, BelongsTo, HasMany, HasManyBy, BelongsToMany, HasManyThrough, MorphTo, MorphOne, MorphMany, MorphToMany, MorphedByMany, Getters, Actions, RootGetters, RootActions, RootMutations };
export default {
    install: install,
    use: use,
    Database: Database,
